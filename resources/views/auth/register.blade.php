			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/register') }}" enctype="multipart/form-data">
						...
						<div class="form-group">
							<div class="col-md-6">
								<input type="hidden" class="form-control" name="ville_id" value="1">
							</div>
						</div>
                        ...
                        <!-- hidden-->
                         <input type="hidden"  id="ville"  class="form-control" name="ville">
                         <input type="hidden"  id="wilaya" class="form-control" name="wilaya">
                         <input type="hidden"  id="geoloc" class="form-control" name="geoloc">
                        <!-- hidden fin-->
